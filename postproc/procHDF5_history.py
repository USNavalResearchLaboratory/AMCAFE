...
This is to be used if you have a list of files of different time steps and
you want to step through the history in paraview. 

If you just want to look at one file, use file procHDF5.py
"""
